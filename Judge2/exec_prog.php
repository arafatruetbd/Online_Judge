...
if ($selected_lang == 'C')
{
  ...
  $query = "select judgetable.ID from judgetable,submitteddata where judgetable.ID = submitteddata.ID and judgetable.judgeNo=2 and
...
if ($selected_lang == 'C++')
{
 ...
 judgetable.judgeNo=2 and judgetable.Lang = '$selected_lang' and judgetable.FileName = '$str' and submitteddata.Verdict = 'Judging'" ;
  $result = mysql_query($query, $link) or die("Cannot Retrive From Table");
  $row = mysql_fetch_row($result);
  $id = $row['0'];
